    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-background to-secondary/20 p-4">
      ...
      >
        <motion.div 
          ...
          className="inline-block px-3 py-1 mb-3 text-xs font-medium tracking-wider uppercase bg-primary/10 text-primary rounded-full"
        >
        ...
        <p className="text-muted-foreground">
          Simule seu financiamento com entrada zero. Escolha o valor, taxa de juros e prazo para calcular suas parcelas mensais.
        </p>
      </motion.div>
