 ...
 * It handles calculations for financing with zero down payment using the Price Table formula.
 * 
 * To use:
 * 1. Add an element with id="price-calculator" to your HTML
 * 2. Include this script in your page
 * 3. The calculator will automatically initialize
 * 
 * You can also use window.initPriceCalculator('#your-selector') to initialize
 * the calculator with a custom selector.
 */
